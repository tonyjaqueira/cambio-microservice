...
public class Cambio implements Serializable{
	...
	@Transient
	private BigDecimal conversuinValue;
	
	@Transient
	private String environment;
	
	public Cambio(Long id, String from, String to, BigDecimal conversionFactor, BigDecimal conversuinValue,
			String environment) {
		super();
		this.id = id;
		this.from = from;
	...
	public BigDecimal getConversuinValue() {
		return conversuinValue;
	}

	public void setConversuinValue(BigDecimal conversuinValue) {
		this.conversuinValue = conversuinValue;
	}
